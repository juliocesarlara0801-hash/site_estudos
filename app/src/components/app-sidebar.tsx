...
const ITENS_MENU = [
  ...
  { titulo: "Questões", url: "/questoes", icone: ClipboardCheck },
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              render={
                <Link href="/dashboard">
                  <div
                    className="flex aspect-square size-8 items-center justify-center rounded-lg text-white shadow-sm shadow-primary/30"
